...
@Entity
@Table(name = "eim_t_project_charter_approval")
public class T_Project_Charter_Approval implements Comparable<T_Project_Charter_Approval> {

	@Override
	public int compareTo(T_Project_Charter_Approval projectCharterApproval) {
		return this.tProjectCharterApprovalId - projectCharterApproval.gettProjectCharterApprovalId();
	}

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "t_project_charter_approval_id",unique = true, nullable = false)
	private Integer tProjectCharterApprovalId;
	...
	public Integer gettProjectCharterApprovalId() {
		return tProjectCharterApprovalId;
	}

	public void settProjectCharterApprovalId(Integer tProjectCharterApprovalId) {
		this.tProjectCharterApprovalId = tProjectCharterApprovalId;
	}
