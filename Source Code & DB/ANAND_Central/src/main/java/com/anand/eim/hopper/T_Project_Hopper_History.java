...
@Entity
@Table(name = "eim_t_project_hopper_history")
public class T_Project_Hopper_History implements Comparable<T_Project_Hopper_History> {

	@Override
	public int compareTo(T_Project_Hopper_History projectHopperHistory) {
		return projectHopperHistory.gettProjectHopperHistoryId() - this.tProjectHopperHistoryId;
	}

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "t_project_hopper_history_id",unique = true, nullable = false)
	private Integer tProjectHopperHistoryId;

	@ManyToOne
	@JoinColumn(name = "t_project_hopper_id", nullable = true)
	private T_Project_Hopper projectHopperHistory;
	...
	private Integer hopperPrimaryDriver; //1-Productivity, 2-Quality, 3-Cost, 4-Delivery, 5-Safety
	...
	public Integer gettProjectHopperHistoryId() {
		return tProjectHopperHistoryId;
	}

	public void settProjectHopperHistoryId(Integer tProjectHopperHistoryId) {
		this.tProjectHopperHistoryId = tProjectHopperHistoryId;
	}

	public T_Project_Hopper getProjectHopperHistory() {
		return projectHopperHistory;
	}

	public void setProjectHopperHistory(T_Project_Hopper projectHopperHistory) {
