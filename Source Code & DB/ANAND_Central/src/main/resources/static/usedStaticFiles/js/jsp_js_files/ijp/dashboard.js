...
$("#openIjp").DataTable({
	...
	"drawCallback": function(settings) {
		if (pagination) {
			$('#openIjp_paginate').find(".pagination").append('<li class="paginate_button page-item"><a onclick="loadNextSetValues()" id="loadMore_openIjp" class="fa fa-arrow-right page-link" href="#" title="Load More"></a></li>');
		}
	},
...
}).buttons().container().appendTo('#openIjp_wrapper .col-md-6:eq(0)');