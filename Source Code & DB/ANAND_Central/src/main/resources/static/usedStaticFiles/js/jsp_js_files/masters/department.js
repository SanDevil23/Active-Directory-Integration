...
var departmentNameCheck = /^[ A-Za-z0-9-Á& ]*$/;
function departmentNameValidation(idAppend) {
	...
	if(departmentName != "") {
		if(departmentNameCheck.test(departmentName) == false) {
...
var departmentDescriptionCheck = /^[ A-Za-z0-9-Á& ]*$/;
function departmentDescriptionValidation(idAppend) {
	...
	if(departmentDescription != "") {
		if(departmentDescriptionCheck.test(departmentDescription) == false) {
