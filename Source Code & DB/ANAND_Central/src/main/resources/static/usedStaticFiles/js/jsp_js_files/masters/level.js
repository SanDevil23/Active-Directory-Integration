...
var levelNameCheck = /^[ A-Za-z0-9-Á& ]*$/;
function levelNameValidation(idAppend) {
	...
	if(levelName != "") {
		if(levelNameCheck.test(levelName) == false) {
...
var levelDescriptionCheck = /^[ A-Za-z0-9-Á& ]*$/;
function levelDescriptionValidation(idAppend) {
	...
	if(levelDescription != "") {
		if(levelDescriptionCheck.test(levelDescription) == false) {
