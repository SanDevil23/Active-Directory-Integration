...
/*function submitNow() {*/
	...
	if(userReportingManagerNameValidation() == false) {
		console.log("9");
		submitOrNot = false;
	}
	if(userReportingManagerMailValidation() == false) {
		console.log("10");
		submitOrNot = false;
	}
...
$("#userReportingManagerName").focusout(function() {
	userReportingManagerNameValidation();
});
function userReportingManagerNameValidation() {
	var userReportingManagerName = $("#userReportingManagerName").val().replace(/\s+/g, " ");
	$("#userReportingManagerNameError").html("");
	$("#userReportingManagerName").removeClass("is-valid");
	$("#userReportingManagerName").removeClass("is-invalid");
	if(userReportingManagerName != "") {
		if(stringCheck.test(userReportingManagerName) == false) {
			$("#userReportingManagerName").addClass("is-invalid");
			$("#userReportingManagerNameError").html("Manager Name can only contain alphabets.");
			return false;
		} else {
			$("#userReportingManagerName").addClass("is-valid");
			return true;
		}
	} else {
		$("#userReportingManagerName").addClass("is-invalid");
		$("#userReportingManagerNameError").html("Manager Name cannot be empty.");
		return false;
	}
}
$("#userReportingManagerMail").focusout(function() {
	userReportingManagerMailValidation();
});
function userReportingManagerMailValidation() {
	$("#userReportingManagerMailError").html("");
	$("#userReportingManagerMail").removeClass("is-valid");
	$("#userReportingManagerMail").removeClass("is-invalid");
	var userReportingManagerMail = $("#userReportingManagerMail").val().replace(/\s+/g, " ");
	if(userReportingManagerMail != "") {
		if(validMailIdFormat.test(userReportingManagerMail) == false) {
			$("#userReportingManagerMail").addClass("is-invalid");
			$("#userReportingManagerMailError").html("Enter valid email address.");
			return false;
		} else {
			$("#userReportingManagerMail").addClass("is-valid");
			return true;
		}
	} else {
		$("#userReportingManagerMail").addClass("is-invalid");
		$("#userReportingManagerMailError").html("Email Address cannot be empty.");
		return false;
	}
}
