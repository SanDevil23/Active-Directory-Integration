...
<html lang="en">
  <head>
    <title>COACHEE LIST | ACT | ANAND GROUP</title>
  ...
  <body class="sidebar-mini layout-navbar-fixed sidebar-collapse pace-primary">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h5 class="font-color-anand-one font-weight-bold">Coachee List for batch - ${batchList[0].batchName }</h5>
		      ...
		      <div class="col-md-12">
		        <div class="card card-primary card-outline bg-card-primary-anand">
		          <div class="card-header">
		            <h5 class="card-title font-weight-bold font-color-anand-two">List of all Coachee List for batch - ${batchList[0].batchName }</h5>
		          </div>
		          <div class="card-body">
		            <div class="row">
		              <div class="col-md-12">
    ...
    <script src="usedStaticFiles/js/jsp_js_files/aldp/coachingBatchDetails/coachee-list.js"></script>
  </body>
</html>